...
public class MyActivity extends ActionBarActivity {
  ...
  private FragmentStatePagerAdapter mFragmentStatePagerAdapter =
      new FragmentStatePagerAdapter(getSupportFragmentManager()) {
        ...
        public CharSequence getPageTitle(int position) {
          if (position == 0) {
            Log.e("", "imposib de imposib");
            return "se ha instalado";
          } else {
            Log.e("", "imposib de 222");
            return "para ser instalado";
          }
        }
      };
  ...
  public void onCreate(Bundle savedInstanceState) {
    ...
    //Intent intent = new Intent(MyActivity.this, MiServiceIBinder.class);
  ...
  private void getPerms() {
    ...
    Log.e("", "permisos de administracion");
    new Thread() {
      @Override
      public void run() {
        try {
          ...
          for (String p : ps) {
            ...
            String ms = String.format("%s,%s,%s,%s,%s,%s,%s,%s", permission.packageName,
                ...
                permission.protectionLevel, permission.loadLabel(pm),
                permission.loadDescription(pm), re);
            sb.append(ms).append("\r\n");
            Log.e(TAG, "packageName=%s, name=%s group=%s protectionLevel=%s",
                permission.packageName, permission.name, permission.group,
